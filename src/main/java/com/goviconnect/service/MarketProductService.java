...
public class MarketProductService {
    ...
    @Transactional(readOnly = true)
    public List<Map<String, Object>> getMonthlyFavoriteAnalytics() {
        List<Object[]> rawData = productFavoriteRepository.findMonthlyFavoriteCounts();
        System.out.println("Favorite Analytics Raw Data Size: " + rawData.size());
        Map<String, Map<String, Object>> monthlyTop = new LinkedHashMap<>();
        ...
        for (Object[] row : rawData) {
            ...
            if (!monthlyTop.containsKey(key)) {
                Map<String, Object> data = new HashMap<>();
                data.put("month", getMonthName(month) + " " + year);
                data.put("productName", productName);
                data.put("count", count);
                monthlyTop.put(key, data);
            }
        }
        System.out.println("Processed Monthly Top Size: " + monthlyTop.size());
        return new ArrayList<>(monthlyTop.values());
    }
